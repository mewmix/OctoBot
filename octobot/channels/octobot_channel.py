...
class OctoBotChannel(Channel):
    ...
    def get_filtered_consumers(self, bot_id: str, subject: str = CHANNEL_WILDCARD, action: str = CHANNEL_WILDCARD):
        """
    ...
    async def _add_new_consumer_and_run(self, consumer,
                                        bot_id=CHANNEL_WILDCARD,
                                        subject=CHANNEL_WILDCARD,
                                        action=CHANNEL_WILDCARD):
        """
